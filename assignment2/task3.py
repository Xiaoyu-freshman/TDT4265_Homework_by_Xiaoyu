...
if __name__ == "__main__":
    ...
    # For efficiency, I used a list for those tricks as follow.
    use_shuffle = [False, True, False, False, False, True]
    use_improved_sigmoid = [False, False, True, False, False, True]
    use_improved_weight_init = [False, False, False, True, False, True]
    use_momentum = [False, False, False, False, True, True]
    ...
    #Plotting code is shown as follows. For efficieny, I commented it in advance. 
#     # Plot loss
...
#     utils.plot_loss(train_loss[1], "Training Loss with shuffle")
#     utils.plot_loss(val_loss[1], "Validation Loss with shuffle")
#     utils.plot_loss(train_loss[2], "Training Loss with improved sigmoid")
#     utils.plot_loss(val_loss[2], "Validation Loss with improved sigmoid")
#     utils.plot_loss(train_loss[3], "Training Loss with improved_weight_init")
#     utils.plot_loss(val_loss[3], "Validation Loss with improved_weight_init")
#     utils.plot_loss(train_loss[4], "Training Loss with momentum")
#     utils.plot_loss(val_loss[4], "Validation Loss with momentum")
#     utils.plot_loss(train_loss[5], "Training Loss with all_tricks")
#     utils.plot_loss(val_loss[5], "Validation Loss with all_tricks")
...
#     utils.plot_loss(train_accuracy[1], "Training Accuracy with shuffle")
#     utils.plot_loss(val_accuracy[1], "Validation Accuracy with shuffle")
#     utils.plot_loss(train_accuracy[2], "Training Accuracy with improved sigmoid")
#     utils.plot_loss(val_accuracy[2], "Validation Accuracy with improved sigmoid")
#     utils.plot_loss(train_accuracy[3], "Training Accuracy with improved_weight_init")
#     utils.plot_loss(val_accuracy[3], "Validation Accuracy with improved_weight_init")
#     utils.plot_loss(train_accuracy[4], "Training Accuracy with momentum")
#     utils.plot_loss(val_accuracy[4], "Validation Accuracy with momentum")
#     utils.plot_loss(train_accuracy[5], "Training Accuracy with all_tricks")
#     utils.plot_loss(val_accuracy[5], "Validation Accuracy with all_tricks")
#     plt.legend()
#     plt.xlabel("Number of gradient steps")
#     plt.ylabel("Accuracy")
#     plt.savefig("softmax_train_graph_comparison_Big_full_scale.png")
#     plt.show()
